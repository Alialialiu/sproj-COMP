...
$usercom_header = $conn->query("SELECT content FROM system_info WHERE label = 'usercom_header'")->fetch_column();
$usercom_content = $conn->query("SELECT content FROM system_info WHERE label = 'usercom_content'")->fetch_column();
...
<body>
   ...
   <section class="container my-4 shadow relative">
      <div class="p-5 text-center bg-body-tertiary rounded-3">
         <i class="bi bi-clipboard-data-fill mt-4 mb-3 fs-1"></i>
         <h1 class="text-body-emphasis"><?php echo $usercom_header ?></h1>
         <p class="col-lg-8 mx-auto fs-5 text-muted">
            <?php echo $usercom_content ?>
         </p>
         <div class="d-inline-flex gap-2 mb-5">
            <button class="d-inline-flex align-items-center btn btn-primary btn-lg px-4 rounded-pill" type="button" type="button" data-bs-toggle="modal" data-bs-target="#addcom_modal">
               Submit complaint
               <i class="bi bi-send-plus-fill ms-2"></i>
            </button>
            <a href="complaintBulletin.php" class="btn btn-outline-secondary btn-lg px-4 rounded-pill" type="button">
               Bulletin
            </a>
         </div>
      </div>
   ...
   <section class="container w-100 p-0">
      <div class="card">
         ...
         <div class="card-body">
            <?php
            if ($complaints_query->num_rows > 0) {
            ?>
            ...
            <?php } else {
               echo '<strong class="text-center fs-4"><center>You don\'t have any complaints yet</center></strong>';
            }
            ?>
         </div>
      </div>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form method="post" id="addcom_form">
                  ...
                  <!-- content -->
                  <div class="mb-3">
                     <label for="addcom_content" class="form-label">Description</label>
